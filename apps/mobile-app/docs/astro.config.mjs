...
const site = 'https://starter.checkright.com/';

// https://astro.build/config
export default defineConfig({
  site: 'https://starter.checkright.com/',
  integrations: [
    starlight({
      title: 'CheckRight Starter | React Native Template',
      ...
      social: {
        github:
          'https://github.com/checkright/react-native-template-checkright',
      },
      head: [
        {
          tag: 'meta',
