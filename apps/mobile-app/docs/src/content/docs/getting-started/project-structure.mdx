...
- `components/ui`: This folder contains all the UI components and the theme configuration. We provide minimal components with a basic `checkright` theme. You can add your own components and theme configuration here.
