...
Mainly the demo app supports one language: English. You can add more languages by adding the translation files in the `src/translations` folder and adding the language code to the `src/lib/i18n/resources.ts` file.
...
![typescript-translation](https://github.com/checkright/react-native-template-checkright/assets/11137944/80a7a0fd-a6f8-4d31-a450-46de797ebdc6)
