---
title: CheckRight Starter | React Native/Expo starter
...
hero:
  ...
  actions:
    - text: Get Started
      ...
      variant: primary
    - text: Hire Us
      link: https://checkright.com/contact?utm_source=starter.checkright.com
      icon: external
      variant: secondary
---
...
[Hire Us](https://checkright.com/contact?utm_source=starter.checkright.com)
