 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.checkright.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.checkright'; // ios bundle id
const PACKAGE = 'com.checkright'; // android package name
const NAME = 'CheckRightApp'; // app name
const EXPO_ACCOUNT_OWNER = 'khalsa_jio'; // expo account owner
const EAS_PROJECT_ID = '3c3ef4dd-c101-44ac-ad72-f8054e4bdbfa'; // eas project id
const SCHEME = 'checkrightApp'; // app scheme
